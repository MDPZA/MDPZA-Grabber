...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("MDPZA Grabber Builder")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  MDPZA Grabber Builder", image=self.logo_image,
    ...
    def get_config(self):
        with open(self.basefilepath + "\\MDPZA.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in MDPZA.py")
